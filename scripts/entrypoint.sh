...
# Mirror SENTRY_DSN to the public runtime config so a single env configures
# both the server (reads SENTRY_DSN directly) and the browser client.
map_env SENTRY_DSN NUXT_PUBLIC_SENTRY_DSN
...
map_env SITE_URL NUXT_SITE_URL
map_env SITE_URL NUXT_PUBLIC_SITE_URL
map_env SITE_URL NUXT_PUBLIC_I18N_BASE_URL
