...
CREATE TABLE "new_File" (
    ...
    "genrePrimary" TEXT NOT NULL DEFAULT '',
    "genreSecondary" TEXT NOT NULL DEFAULT '',
    "genreConfidence" REAL,
    "genreReason" TEXT NOT NULL DEFAULT '',
    "genreModel" TEXT NOT NULL DEFAULT '',
    "genreUpdatedAt" DATETIME,
