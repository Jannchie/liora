...
INSERT INTO "new_File" ("aperture", "cameraModel", "captureTime", "characterList", "createdAt", "description", "fanworkTitle", "focalLength", "height", "id", "imageUrl", "iso", "kind", "location", "metadata", "shutterSpeed", "title", "width") SELECT "aperture", "cameraModel", "captureTime", "characterList", "createdAt", "description", "fanworkTitle", "focalLength", "height", "id", "imageUrl", "iso", "kind", "location", "metadata", "shutterSpeed", "title", "width" FROM "File";
DROP TABLE "File";
