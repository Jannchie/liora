  ...
  <div class="space-y-4">
    <div class="flex items-center justify-between gap-3">
      <div class="flex items-center gap-2">
        <Icon name="tabler:photo" class="h-4 w-4 text-muted" />
    ...
    <div
      class="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-xl bg-muted outline-none ring-primary/40 transition focus-visible:ring-2"
    ...
    <div v-if="props.isUploading" class="space-y-2 border-t border-border-muted pt-4">
      ...
      <div class="h-1 w-full overflow-hidden rounded-full bg-border-muted">
        <div
