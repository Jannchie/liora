...
<template>
  <div
    v-if="visible && label"
    class="pointer-events-none absolute bottom-4 right-4 z-40 min-w-40 max-w-[320px] rounded-md border border-white/10 bg-black/80 px-3.5 py-3 text-xs text-white backdrop-blur-sm ring-1 ring-white/5"
  >
