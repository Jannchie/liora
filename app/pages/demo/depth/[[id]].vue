...
const directionDurationSeconds = ref(1.8)
const depthDurationSeconds = ref(1.8)
const maxBlur = ref(40)
const directionalDelay = ref(0.5)
const depthDelay = ref(0.2)
const depthEasePower = ref(1)
